...
def plot_embedding_2D(data, label, epoch,len_covert):
    ...
    plt.scatter(data[0:len_covert,0], data[0:len_covert,1], c="none", marker="o", edgecolors='red', s=12, label="Covert signal")
    plt.scatter(data[len_covert:,0], data[len_covert:,1], c="none", marker="^", edgecolors='gray',s=12, label="AN")
    plt.xlim(0, 1)
    plt.ylim(0, 1)
...
def constellation_image(sample_data, real_data, args, epoch):
    ...
    plt.scatter(sample_data[:,0], sample_data[:,1], c="red", marker="+", s=10, label="Covert signal")
    plt.scatter(real_data[:,0], real_data[:,1], c="gray", marker=".", s=10, label="AN")
